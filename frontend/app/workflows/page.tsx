    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-[1600px] mx-auto px-8 py-16">
          <div className="max-w-3xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 border border-blue-200 rounded-md text-blue-700 text-sm font-medium mb-6"
            >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg transition-all flex items-center gap-3"
              >
                <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center">
                  🤖
                </div>
                <div className="text-left">
                  <div className="text-sm font-bold">FourKites AI Agent Builder</div>
                  <div className="text-xs text-blue-100">Chat to create workflows from requirements</div>
                </div>
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link
                  href="/builder?guide=true"
                  className="px-6 py-3.5 bg-white hover:bg-gray-50 text-slate-900 font-semibold rounded-xl border-2 border-slate-200 hover:border-slate-300 transition-all flex items-center gap-2 shadow-sm"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
                  </svg>
                  <div className="text-left">
                    <div className="text-sm font-bold">Manual Visual Builder</div>
                    <div className="text-xs text-slate-500">Drag-and-drop workflow creation</div>
                  </div>
                </Link>
              </motion.div>
            </motion.div>
      ...
      <div className="bg-gradient-to-b from-slate-50 to-white py-16">
        <div className="max-w-[1600px] mx-auto px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-slate-900 mb-3">Two Ways to Build Your Workflows</h2>
            <p className="text-lg text-slate-600">Choose the method that works best for your team</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              className="bg-white border-2 border-blue-200 rounded-2xl p-8 shadow-lg"
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">FourKites AI Agent Builder</h3>
                  <p className="text-sm text-blue-600 font-semibold">Conversational Workflow Creation</p>
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700">Chat with AI to describe your requirements</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">Upload requirement documents or PDFs</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">AI automatically generates workflow structure</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">Refine with natural language commands</span>
                </li>
              </ul>

              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                <p className="text-sm text-blue-900 font-medium mb-1">Best for:</p>
                <p className="text-sm text-blue-700">Teams with complex requirements, document-driven processes, or those new to workflow automation</p>
              </div>

              <button
                onClick={() => setShowAIBuilder(true)}
                className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg transition-all"
              >
                Try AI Agent Builder
              </button>
            </motion.div>

            {/* Manual Visual Builder Card */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.5 }}
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-900 mb-2">Manual Visual Builder</h3>
                  <p className="text-sm text-slate-600 font-semibold">Drag-and-Drop Interface</p>
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700">Drag action blocks onto the canvas</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">Connect nodes to define workflow logic</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">Configure parameters with forms</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-slate-700">Full control over every workflow detail</span>
                </li>
              </ul>

              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-6">
                <p className="text-sm text-slate-900 font-medium mb-1">Best for:</p>
                <p className="text-sm text-slate-700">Technical teams who prefer hands-on control, iterative design, or modifying existing workflows</p>
              </div>

              <Link
                href="/builder?guide=true"
                className="block w-full py-3 bg-slate-900 hover:bg-slate-800 text-white text-center font-semibold rounded-xl shadow-lg transition-all"
              >
                Open Visual Builder
              </Link>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredTemplates.map((template, index) => (
              <motion.div
                ...
                className="group bg-white border border-slate-200 rounded-xl overflow-hidden hover:border-slate-300 transition-all duration-200"
              >
                {/* Template Header */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {actions.map((action, actionIndex) => (
                  <motion.div
                    ...
                    className="bg-white border border-slate-200 rounded-xl p-5 hover:border-slate-300 transition-all group"
                  >
